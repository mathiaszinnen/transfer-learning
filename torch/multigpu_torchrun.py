...
def main(save_every: int, total_epochs: int, batch_size: int, train_imgs, train_anns, snapshot_path):
    ddp_setup()
...
if __name__ == "__main__":
    ...
    main(args.save_every, args.total_epochs, args.batch_size, args.train_imgs, args.train_anns, args.output_model_pth)
